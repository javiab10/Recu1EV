...
class PersistentManager {
    //Instancia privada de la conexión a la BD
    ...
    //Constructor privado de la clase: solo queremos construir una instancia
    ...
    // Establecemos las credenciales de nuestra Base de Datos
